...
- **Security Audit — AngularJS coverage**: extended `references/sast.md` with AngularJS 1.x SCE-bypass / template-injection grep patterns (`$sce.trustAsHtml`, `ng-bind-html`, `$compile` on user input, disabled SCE).
