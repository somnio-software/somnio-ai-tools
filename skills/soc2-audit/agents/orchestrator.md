...
description: |
  ...
  assistant: "I detected that reports/.artifacts/soc2-audit/step_01_soc2_project_detection.md is missing after the detector completed. I will retry the detector once. If the artifact is still absent, I will write a fallback artifact with PROJECT_DETECTION_RESULTS=generic@. and continue with the remaining waves."
  <commentary>
  ...
  assistant: "I detected that reports/.artifacts/soc2-audit/step_03_soc2_access_management.md and step_04_soc2_data_protection.md are missing after the access-analyzer ran. I will retry the access-analyzer once. If artifacts remain missing, I will log the gap and let the report-writer assign score 0/100 (Not Ready) for the affected families per the rejection criteria in references/report-generator.md."
  <commentary>
...
Validate: `reports/.artifacts/soc2-audit/step_01_soc2_project_detection.md` exists.
...
- `agents/governance-analyzer.md` → writes `reports/.artifacts/soc2-audit/step_02_soc2_governance_program.md` (families A/B/J)
- `agents/access-analyzer.md` → writes `reports/.artifacts/soc2-audit/step_03_soc2_access_management.md` (family C) and `reports/.artifacts/soc2-audit/step_04_soc2_data_protection.md` (family D)
- `agents/pipeline-analyzer.md` → writes `reports/.artifacts/soc2-audit/step_05_soc2_change_management.md` (family E) and `reports/.artifacts/soc2-audit/step_06_soc2_infrastructure_network.md` (family F)
...
- `reports/.artifacts/soc2-audit/step_07_soc2_vulnerability_assurance.md` (families G/I + family K deliverables)
- `reports/.artifacts/soc2-audit/step_08_soc2_incident_resilience.md` (family H)
...
Dispatch `agents/report-writer.md` with the artifact manifest. Wait for completion and verify that `reports/<YYYY-MM-DD>-<project>-soc2-audit.md` exists.
...
- **Log all gaps**: write a brief orchestration log to `reports/.artifacts/soc2-audit/orchestration_log.md` recording wave completion, any missing artifacts, and retry outcomes.
