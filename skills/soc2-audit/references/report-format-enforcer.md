...
./reports/<YYYY-MM-DD>-<project>-soc2-audit.md

JSON EXPORT (mandatory):
After validating and exporting the text report to reports/<YYYY-MM-DD>-<project>-soc2-audit.md,
ensure reports/<YYYY-MM-DD>-<project>-soc2-audit.json exists and is well-formed with the schema
