...
- local: `agent-rules/rules/flutter/architecture.md`
  raw:   https://raw.githubusercontent.com/somnio-software/somnio-ai-tools/main/agent-rules/rules/flutter/architecture.md
