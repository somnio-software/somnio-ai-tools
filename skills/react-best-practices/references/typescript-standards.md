...
- local: `agent-rules/rules/react/typescript.md`
  raw:   https://raw.githubusercontent.com/somnio-software/somnio-ai-tools/main/agent-rules/rules/react/typescript.md
