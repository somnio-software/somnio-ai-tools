...
description: |
  ...
  user: "Produce the executive summary and score breakdown for the react-best-practices report."
  ...
  user: "What are the top recommendations from the react-best-practices audit?"
...
1. `reports/.artifacts/react-best-practices/step_01_typescript_scan.md` — TypeScript scanner inventory
2. `reports/.artifacts/react-best-practices/step_02_architecture_scan.md` — Architecture scanner inventory
3. `reports/.artifacts/react-best-practices/step_03_testing_quality.md` — Testing analysis + score
4. `reports/.artifacts/react-best-practices/step_04_architecture_analysis.md` — Architecture analysis + score
5. `reports/.artifacts/react-best-practices/step_05_hooks_analysis.md` — Hooks analysis + score
6. `reports/.artifacts/react-best-practices/step_06_state_analysis.md` — State analysis + score
7. `reports/.artifacts/react-best-practices/step_07_performance_analysis.md` — Performance analysis + score
...
Weighted Overall = (testing x 0.20) + (architecture x 0.25) + (hooks x 0.15) + (state x 0.15) + (performance x 0.15) + (typescript x 0.10)
