...
- local: `agent-rules/rules/nestjs/testing-unit.md`
  raw:   https://raw.githubusercontent.com/somnio-software/somnio-ai-tools/main/agent-rules/rules/nestjs/testing-unit.md
- local: `agent-rules/rules/nestjs/testing-integration.md`
  raw:   https://raw.githubusercontent.com/somnio-software/somnio-ai-tools/main/agent-rules/rules/nestjs/testing-integration.md
