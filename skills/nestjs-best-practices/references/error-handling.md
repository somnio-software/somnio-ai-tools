...
- local: `agent-rules/rules/nestjs/error-handling.md`
  raw:   https://raw.githubusercontent.com/somnio-software/somnio-ai-tools/main/agent-rules/rules/nestjs/error-handling.md
