# NestJS DTO Validation Analysis

> Analyze DTO structure, class-validator usage, class-transformer patterns, and Swagger documentation.
...
- local: `agent-rules/rules/nestjs/dto-validation.md`
  raw:   https://raw.githubusercontent.com/somnio-software/somnio-ai-tools/main/agent-rules/rules/nestjs/dto-validation.md
