# Python Best Practices Format Enforcer
...
2.  **MARKDOWN STRUCTURE**:
    ...
    *   Code refs: `` `path/to/file.py:42` ``
    *   File paths: `` `src/users/users_service.py:42` ``
...
Key Findings:
- 85% of modules have unit tests
- Integration tests use proper setup/teardown patterns
- Some tests missing assertions
- Mock setup is consistent across files

Evidence:
- "tests/users/test_users_service.py:15" - Good AAA pattern usage
- "tests/orders/test_orders_service.py:42" - Missing assertion
...
2. Implement teardown cleanup in integration tests
