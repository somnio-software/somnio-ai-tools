...
7. **Save Output**: Write the analysis artifact to `reports/.artifacts/python_health/step_09_harness_analysis.md`.
...
Save your complete analysis to `reports/.artifacts/python_health/step_09_harness_analysis.md`.

Create the directory first: `mkdir -p "$(dirname reports/.artifacts/python_health/step_09_harness_analysis.md)"`
