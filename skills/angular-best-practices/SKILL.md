...
| 3 | `agents/report-writer.md` | frontier | `references/best-practices-format-enforcer.md` + `references/best-practices-generator.md` + all step artifacts | `reports/<YYYY-MM-DD>-<project>-angular-best-practices.md` |
...
```
<YYYY-MM-DD>-<project>-angular-best-practices.md
```
...
REPORT="reports/$(date +%F)-$(basename "$PWD" \
  | tr '[:upper:]' '[:lower:]' | tr ' _./' '-' \
  | sed -E 's/[^a-z0-9-]//g; s/-+/-/g; s/^-|-$//g')-angular-best-practices.md"
```

Everywhere this skill writes `reports/<YYYY-MM-DD>-<project>-angular-best-practices.md`, it
