...
7. **Save Output**: Write the analysis artifact to `reports/.artifacts/react-health-audit/step_08_harness_analysis.md`.
...
Save your complete analysis to `reports/.artifacts/react-health-audit/step_08_harness_analysis.md`.

Create the directory first: `mkdir -p "$(dirname reports/.artifacts/react-health-audit/step_08_harness_analysis.md)"`
