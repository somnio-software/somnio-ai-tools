...
7. **Save Output**: Write the analysis artifact to `reports/.artifacts/flutter-health-audit/step_07_harness_analysis.md`.
...
Save your complete analysis to `reports/.artifacts/flutter-health-audit/step_07_harness_analysis.md`.

Create the directory first: `mkdir -p "$(dirname reports/.artifacts/flutter-health-audit/step_07_harness_analysis.md)"`
