...
name: report-writer
description: |
  Use this agent when synthesizing all angularjs-best-practices audit artifacts into the final weighted report. Reads all step artifacts + assets/report-template.md + format-enforcer and generator references, computes weighted section scores, and writes reports/angularjs-best-practices-report.md.
...
Write the complete final report to `reports/angularjs-best-practices-report.md`.
