...
Write the detection artifact to `reports/.artifacts/iso27001-audit/step_01_iso27001_project_detection.md` (run `mkdir -p reports/.artifacts/iso27001-audit` first). Include PROJECT_DETECTION_RESULTS (pipe-separated type@path), package managers, repository structure, and the enumerated evidence surfaces with their actual paths.
